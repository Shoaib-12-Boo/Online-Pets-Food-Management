...
<html lang="en">
	<head>
	    ...
	    <title>PetWell | Browse - Category</title>
	    <!-- Bootstrap Core CSS -->
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head" style="font: 16px/1.335 'Open Sans', Arial, Helvetica, sans-serif; text-transform: capitalize;"><i class="fa fa-paw" aria-hidden="true"></i> &nbsp Customer Favorites</div>        
...
{
    ?>
                <a href="sub-category.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title" style="font: 14px/1.335 'Open Sans', Arial, Helvetica, sans-serif; text-transform: capitalize;"><b>Shop By</b></h3>
	            	<div class="sidebar-filter">
		            	<!-- ============================================== SIDEBAR CATEGORY ============================================== -->
<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
	<div class="widget-header m-t-20">
		<h4 class="widget-title" style="font: 16px/1.335 'Open Sans', Arial, Helvetica, sans-serif; text-transform: capitalize;"><i class="fa fa-paw" aria-hidden="true"></i> &nbsp Browse</h4>
	</div>
